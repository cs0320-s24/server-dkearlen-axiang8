 ...
 * @version 1.0 - CachingACSAPI is a class that helps cache the inputs given by the API.
 * If a recent search is found in the cache, it will return from the cache instead of making another input.
 * */
public class CachingACSAPI implements APIDataSource {
            ...
            new CacheLoader<>() {
              ...
              public InternetAccessData load(String key)
                ...
                try {
                  ...
                  // All these throws will be thrown as a UncheckedExecutionException to be handled in BroadbandHandler
                } catch (IOException e){
   ...
   * @return - Returns an InternetAccessData record to be extracted from in BroadbandHandler for its data.
   * */
  @Override
