...
public class TestView {
  ...
  public void testViewCSVWithSuccessfulLoad() throws IOException {
    ...
    ViewCSVHandler.CSVSuccessResponse response =
        moshi
            .adapter(ViewCSVHandler.CSVSuccessResponse.class)
  ...
  public void testViewCSVWithUnsuccessfulLoad() throws IOException {
    ...
    ViewCSVHandler.CSVFailureResponse response =
        moshi
            .adapter(ViewCSVHandler.CSVFailureResponse.class)
