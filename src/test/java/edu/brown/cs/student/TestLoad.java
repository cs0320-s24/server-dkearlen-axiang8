...
public class TestLoad {
  ...
  public void testLoadCleanData() throws IOException {
    ...
    LoadCSVHandler.CSVSuccessResponse response =
        moshi
            .adapter(LoadCSVHandler.CSVSuccessResponse.class)
  ...
  public void testLoadWrongDirectory() throws IOException {
    ...
    assertEquals(200, clientConnection.getResponseCode());
    LoadCSVHandler.CSVFailureResponse response =
        moshi
            .adapter(LoadCSVHandler.CSVFailureResponse.class)
            .fromJson(new Buffer().readFrom(clientConnection.getInputStream()));
  ...
  public void testInvalidFile() throws IOException {
    HttpURLConnection clientConnection =
        tryRequest(
            "loadcsv?filepath=/Users/austinxiang/Desktop/brown/cs32/server-dkearlen-axiang8/data/CA_Income.csv");
    assertEquals(200, clientConnection.getResponseCode());
    LoadCSVHandler.CSVFailureResponse response =
        moshi
            .adapter(LoadCSVHandler.CSVFailureResponse.class)
  ...
  public void testMalformedFile() throws IOException {
    HttpURLConnection clientConnection =
        tryRequest(
            "loadcsv?filepath=/Users/austinxiang/Desktop/brown/cs32/server-dkearlen-axiang8/data/malformed_signs.csv");
    assertEquals(200, clientConnection.getResponseCode());
    LoadCSVHandler.CSVFailureResponse response =
        moshi
            .adapter(LoadCSVHandler.CSVFailureResponse.class)
