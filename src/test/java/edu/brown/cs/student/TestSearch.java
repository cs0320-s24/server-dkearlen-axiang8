...
public class TestSearch {
    ...
    public void testSearchCSVWithUnsuccessfulLoad() throws IOException {
        ...
        SearchCSVHandler.CSVFailureResponse response = moshi.adapter(SearchCSVHandler.CSVFailureResponse.class).fromJson(new Buffer().readFrom(clientConnection1.getInputStream()));
    ...
    public void testSearchCSVWithHeaders() throws IOException {
        ...
        assertEquals(200, clientConnection1.getResponseCode());
        SearchCSVHandler.CSVSuccessResponse response = moshi.adapter(SearchCSVHandler.CSVSuccessResponse.class).fromJson(new Buffer().readFrom(clientConnection1.getInputStream()));
        assertEquals("{type=search_success, target=69, headers=false, search_results={\"data\":[[\"Barrington\",\"130,455.00\",\"154,441.00\",\"69,917.00\"],[\"Cranston\",\"77,145.00\",\"95,763.00\",\"38,269.00\"],[\"West Warwick\",\"62,649.00\",\"80,699.00\",\"36,148.00\"]]}}", response.responseMap().toString());
    }
    @Test
    public void testSearchCSVWithoutHeaders() throws IOException {
        HttpURLConnection clientConnection = tryRequest("loadcsv?filepath=/Users/austinxiang/Desktop/brown/cs32/server-dkearlen-axiang8/data/RI_Income_No_Headers.csv");
        assertEquals(200, clientConnection.getResponseCode());
        HttpURLConnection clientConnection1 = tryRequest("searchcsv?target=33&headers=false");
        assertEquals(200, clientConnection1.getResponseCode());
        SearchCSVHandler.CSVSuccessResponse response = moshi.adapter(SearchCSVHandler.CSVSuccessResponse.class).fromJson(new Buffer().readFrom(clientConnection1.getInputStream()));
        assertEquals("{type=search_success, target=33, headers=false, search_results={\"data\":[[\"Central Falls\",\"40,235.00\",\"42,633.00\",\"17,962.00\"],[\"East Greenwich\",\"133,373.00\",\"173,775.00\",\"71,096.00\"],[\"Warwick\",\"77,110.00\",\"97,033.00\",\"41,476.00\"]]}}", response.responseMap().toString());
    }
    @Test
    ...
    public void testSearchCSVWithInvalidStringIndex() throws IOException {
        HttpURLConnection clientConnection = tryRequest("loadcsv?filepath=/Users/austinxiang/Desktop/brown/cs32/server-dkearlen-axiang8/data/RI_Income.csv");
        assertEquals(200, clientConnection.getResponseCode());
        HttpURLConnection clientConnection1 = tryRequest("searchcsv?target=33&headers=true&indexType=string&index=notvalidindex");
        assertEquals(200, clientConnection1.getResponseCode());
        SearchCSVHandler.CSVFailureResponse response = moshi.adapter(SearchCSVHandler.CSVFailureResponse.class).fromJson(new Buffer().readFrom(clientConnection1.getInputStream()));
        assertEquals("error", response.response_type());
        assertEquals("Index not found. Columns available: City/Town, Median Household Income, Median Family Income, Per Capita Income", response.responseMap().get("error_type"));
    }
    ...
    public void testSearchCSVWithIndexNoType() throws IOException {
        HttpURLConnection clientConnection = tryRequest("loadcsv?filepath=/Users/austinxiang/Desktop/brown/cs32/server-dkearlen-axiang8/data/RI_Income.csv");
        assertEquals(200, clientConnection.getResponseCode());
        HttpURLConnection clientConnection1 = tryRequest("searchcsv?target=33&headers=true&index=hello");
        assertEquals(200, clientConnection1.getResponseCode());
        SearchCSVHandler.CSVFailureResponse response = moshi.adapter(SearchCSVHandler.CSVFailureResponse.class).fromJson(new Buffer().readFrom(clientConnection1.getInputStream()));
        assertEquals("error", response.response_type());
        assertEquals("Must declare index type, either 'string' or 'int', along with index: 1", response.responseMap().get("error_type"));
    }
    ...
    public void testSearchCSVWithInvalidIntIndex() throws IOException {
        HttpURLConnection clientConnection = tryRequest("loadcsv?filepath=/Users/austinxiang/Desktop/brown/cs32/server-dkearlen-axiang8/data/RI_Income.csv");
        assertEquals(200, clientConnection.getResponseCode());
        HttpURLConnection clientConnection1 = tryRequest("searchcsv?target=33&headers=true&indexType=int&index=-1");
        assertEquals(200, clientConnection1.getResponseCode());
        SearchCSVHandler.CSVFailureResponse response = moshi.adapter(SearchCSVHandler.CSVFailureResponse.class).fromJson(new Buffer().readFrom(clientConnection1.getInputStream()));
        assertEquals("error", response.response_type());
        assertEquals("Index must be greater than 0, less than 4", response.responseMap().get("error_type"));
    }
    ...
    public void testSearchCSVWithStringDeclaredAsInt() throws IOException {
        HttpURLConnection clientConnection = tryRequest("loadcsv?filepath=/Users/austinxiang/Desktop/brown/cs32/server-dkearlen-axiang8/data/RI_Income.csv");
        assertEquals(200, clientConnection.getResponseCode());
        HttpURLConnection clientConnection1 = tryRequest("searchcsv?target=33&headers=true&indexType=int&index=hello");
        assertEquals(200, clientConnection1.getResponseCode());
        SearchCSVHandler.CSVFailureResponse response = moshi.adapter(SearchCSVHandler.CSVFailureResponse.class).fromJson(new Buffer().readFrom(clientConnection1.getInputStream()));
        assertEquals("error", response.response_type());
    ...
    public void testSearchCSVWithInvalidIndexType() throws IOException {
        HttpURLConnection clientConnection = tryRequest("loadcsv?filepath=/Users/austinxiang/Desktop/brown/cs32/server-dkearlen-axiang8/data/RI_Income.csv");
        assertEquals(200, clientConnection.getResponseCode());
        HttpURLConnection clientConnection1 = tryRequest("searchcsv?target=33&headers=true&indexType=boolean&index=hello");
        assertEquals(200, clientConnection1.getResponseCode());
        SearchCSVHandler.CSVFailureResponse response = moshi.adapter(SearchCSVHandler.CSVFailureResponse.class).fromJson(new Buffer().readFrom(clientConnection1.getInputStream()));
        assertEquals("error", response.response_type());
        assertEquals("Invalid index type. Must be either 'int' or 'string'", response.responseMap().get("error_type"));
    }
